...
export function PatientHistoryDoctor() {
  ...
  const handleChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    async function fetchSchedules() {
        ...
        //   password: password
        // }))
        const response = await fetch('http://localhost:5000/patient/getSchedules?id=' + authStorage.userId + "&isBooked=" + false, {
         }) 
    ...
    return (
            ...
            {schedules.map(schedules => <PatientHistoryCard  date={schedules.date} start_time= {schedules.start_time} end_time ={schedules.end_time} 
